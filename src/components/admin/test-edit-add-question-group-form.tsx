...
export interface TestEditAddQuestionGroupFormHandle {
      ...
      <div className="border-2 border-dashed border-blue-300 rounded-lg p-4 bg-blue-50/30 space-y-3">
        ...
        <div className={`grid gap-3 ${skill !== 'LISTENING' ? 'grid-cols-2' : 'grid-cols-1'}`}>
          ...
          <div>
            ...
            <Input
              ...
              placeholder="VD: Choose the correct letter..."
        ...
        {typeCode === 'MATCHING_FEATURE' ? (
          <div className="space-y-3">
            <SharedOptionsEditor options={sharedOptions} onChange={setSharedOptions} />
            <MatchingTableEditor
