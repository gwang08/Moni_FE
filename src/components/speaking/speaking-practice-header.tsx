...
export function SpeakingPracticeHeader({
  ...
  return (
    <div className="relative z-20 bg-warm-white/60 backdrop-blur-xl border-b border-orange-100/50 px-5 py-2.5 flex items-center justify-between shrink-0 shadow-[0_1px_12px_-2px_rgba(251,146,60,0.08)]">
      {/* Left */}
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex items-center gap-1.5 bg-warm-white/80 backdrop-blur-sm px-3 py-1.5 rounded-full border border-orange-100/50 shadow-sm">
