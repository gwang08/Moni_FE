...
export function ExamPart1IntroScreen({ onStartNow }: Props) {
  return (
    <div className="flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white min-h-[500px]">
      <div className="py-6 text-center">
        <h2 className="text-[20px] font-bold text-[#334155]">Part 1</h2>
      </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center p-8 text-center mb-10">
        <ul className="space-y-3 text-[#334155] max-w-lg text-left inline-block">
          <li className="leading-relaxed text-[15px]">Part 1 will take about 4 to 5 minutes.</li>
          <li className="leading-relaxed text-[15px]">
            The examiner will ask you some general questions about yourself, your family, your work or studies, and familiar topics.
          </li>
        </ul>
      </div>
