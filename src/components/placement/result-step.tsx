...
import { BookOpen, Headphones, PenLine, Mic, ArrowRight, TrendingUp, CheckCircle2 } from 'lucide-react';
...
const SKILLS: {
  ...
  { key: 'reading', label: 'Reading', icon: BookOpen, color: 'text-blue-600', bg: 'bg-blue-50', border: 'border-blue-100', ring: 'from-blue-400 to-indigo-500' },
  { key: 'listening', label: 'Listening', icon: Headphones, color: 'text-purple-600', bg: 'bg-purple-50', border: 'border-purple-100', ring: 'from-purple-400 to-violet-500' },
  { key: 'writing', label: 'Writing', icon: PenLine, color: 'text-emerald-600', bg: 'bg-emerald-50', border: 'border-emerald-100', ring: 'from-emerald-400 to-teal-500' },
  { key: 'speaking', label: 'Speaking', icon: Mic, color: 'text-orange-600', bg: 'bg-orange-50', border: 'border-orange-100', ring: 'from-orange-400 to-rose-500' },
];
      ...
      <div className="w-full max-w-lg space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          {SKILLS.map((skill) => {
            ...
            return (
              <div key={skill.key} className={`rounded-2xl border ${skill.border} ${skill.bg} p-4 space-y-2.5 transition-all hover:shadow-md`}>
